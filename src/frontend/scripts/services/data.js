 ...
 * ---------------------------------------------------------------------
 * Diese Datei stellt alle dynamischen Inhalte als globale window.*-
 * Variablen bereit. Die Generatoren in app.js lesen daraus und rendern
 * das Markup. Auf Seiten, die einen bestimmten Datensatz nicht
 * benötigen, wird er einfach ignoriert.
 * ===================================================================== */

'use strict';

/* ---------- BENTO-BOX (Startseite) ------------------------------------ */
// Hinweis: Die `link`-Pfade sind relativ zur Startseite (/index.html),
// daher beginnen sie mit `src/frontend/pages/...`.
window.bentoProjects = [
    {
        ...
        link: 'src/frontend/pages/projekte.html'
    },
    {
        tag: 'Event',
        ...
        link: 'src/frontend/pages/events.html'
    },
    {
        tag: 'Team',
        ...
        link: 'src/frontend/pages/team.html'
    },
    {
        tag: 'Projekt',
...
window.teamMembers = [
    ...
    },
    {
        name: 'Plmko Ij',
        roleFront: 'Yxcvb Nm',
        roleBack: 'Website, Social Media, IT-Support',
        age: '19',
...
/* ---------- ABGESCHLOSSENE PROJEKTE (Film-Roll) ----------------------- */
